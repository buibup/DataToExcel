<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DataToExcel.Default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <p>
                <input type="button" onserverclick="ExportToExcel"
                    value="Export data to Excel" runat="server" />
            </p>

            <!-- SHOW MESSAGE. -->
            <p>
                <asp:Label ID="lblConfirm" Text="" runat="server"></asp:Label></p>
